...
var SettingsWindow = /** @class */ (function (_super) {
    ...
    function SettingsWindow(app, local, mainWindow, microphone, miniModeWindow, settings) {
    ...
    SettingsWindow.create = function (app, bridge, local, mainWindow, microphone, miniModeWindow, settings) {
        return __awaiter(this, void 0, void 0, function () {
            var instance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = new SettingsWindow(app, local, mainWindow, microphone, miniModeWindow, settings);
    ...
    SettingsWindow.prototype.height = function () {
        return 400;
    };
    ...
    SettingsWindow.prototype.position = function () {
        return this.positionNearMainWindow(this.mainWindow);
    };
    SettingsWindow.prototype.show = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.microphone.register("settings", function () { });
    ...
    SettingsWindow.prototype.title = function () {
        return "ArqonMaestro Settings";
    };
    SettingsWindow.prototype.url = function () {
        return "settings";
    };
    SettingsWindow.prototype.width = function () {
        return 450;
    };
