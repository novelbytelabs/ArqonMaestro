#include "ai_arqon_maestro_treesitter_TreeSitter.h"
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
  ...
  _loadClass(_nodeClass, "ai/arqon/maestro/treesitter/Node");
  ...
  _loadClass(_treeCursorNodeClass, "ai/arqon/maestro/treesitter/TreeCursorNode");
...
Java_ai_arqon_maestro_treesitter_TreeSitter_parserNew(JNIEnv* env, jclass self) {
...
Java_ai_arqon_maestro_treesitter_TreeSitter_treeCursorCurrentFieldName(
...
Java_ai_arqon_maestro_treesitter_TreeSitter_treeCursorCurrentNode(JNIEnv* env,
                                                             jclass self,
                                                             jlong cursor) {
...
JNIEXPORT jobject JNICALL
Java_ai_arqon_maestro_treesitter_TreeSitter_treeCursorCurrentTreeCursorNode(
    JNIEnv* env, jclass self, jlong cursor) {
...
Java_ai_arqon_maestro_treesitter_TreeSitter_treeCursorGotoFirstChild(JNIEnv* env,
                                                                jclass self,
                                                                jlong cursor) {
...
JNIEXPORT jboolean JNICALL
Java_ai_arqon_maestro_treesitter_TreeSitter_treeCursorGotoNextSibling(JNIEnv* env,
                                                                 jclass self,
                                                                 jlong cursor) {
...
JNIEXPORT jboolean JNICALL
Java_ai_arqon_maestro_treesitter_TreeSitter_treeCursorGotoParent(JNIEnv* env,
                                                            jclass self,
                                                            jlong cursor) {
