...
export interface H3RuntimeEvidenceEvent {
  ...
  dynamicPrecisionCurrentRegimeId: string | null;
...
function buildDefaultEvent(input: Partial<H3RuntimeEvidenceEvent>): H3RuntimeEvidenceEvent {
  return {
    ...
    dynamicPrecisionRegimeSchemaVersion:
      input.dynamicPrecisionRegimeSchemaVersion ?? null,
    dynamicPrecisionRegimePolicyVersion:
      input.dynamicPrecisionRegimePolicyVersion ?? null,
    dynamicPrecisionCurrentRegimeId:
      input.dynamicPrecisionCurrentRegimeId ?? null,
    dynamicPrecisionCurrentRegimeSource:
      input.dynamicPrecisionCurrentRegimeSource ?? null,
    dynamicPrecisionCurrentRegimeReasonCodes:
      input.dynamicPrecisionCurrentRegimeReasonCodes ?? null,
    dynamicPrecisionEscalationPilotVersion:
      input.dynamicPrecisionEscalationPilotVersion ?? null,
    dynamicPrecisionEscalationPilotApplied:
      input.dynamicPrecisionEscalationPilotApplied ?? null,
    dynamicPrecisionEscalationSuggested:
      input.dynamicPrecisionEscalationSuggested ?? null,
    dynamicPrecisionProposedRegimeId:
      input.dynamicPrecisionProposedRegimeId ?? null,
    dynamicPrecisionEscalationSource:
      input.dynamicPrecisionEscalationSource ?? null,
    dynamicPrecisionEscalationReasonCodes:
      input.dynamicPrecisionEscalationReasonCodes ?? null,
    dynamicPrecisionStressBand:
      input.dynamicPrecisionStressBand ?? null,
