...
export default class ChunkManager {
  ...
  private getDynamicPrecisionRegimeEvidenceFields(
    chunkId: string,
    counterfactualFields: any,
    seed: Partial<{ commandClass: string | null; parameterType: string | null }> = {}
  ) {
    const latest = this.chunkH3LatestGeometricEvent.get(chunkId);
    return deriveDynamicPrecisionRegimeEvidenceFields({
      commandClass: seed.commandClass ?? latest?.commandClass ?? null,
      parameterType: seed.parameterType === "numeric" || seed.parameterType === "open"
        ? seed.parameterType
        : (latest?.parameterType ?? null),
      ambiguityPilotApplied: counterfactualFields.counterfactualRepairAmbiguityPilotApplied ?? null,
      ambiguityEscalationKind: counterfactualFields.counterfactualRepairAmbiguityEscalationKind ?? null,
      ambiguityScoreGap: counterfactualFields.counterfactualRepairAmbiguityScoreGap ?? null,
      repairSignalPilotApplied: counterfactualFields.counterfactualRepairSignalPilotApplied ?? null,
      repairWindowOpen: counterfactualFields.counterfactualRepairSignalRepairWindowOpen ?? null,
      repairEscalationKind: counterfactualFields.counterfactualRepairSignalEscalationKind ?? null,
      rankingPilotApplied: counterfactualFields.counterfactualRepairRankingPilotApplied ?? null,
      rankingGuardrailSuggested: counterfactualFields.counterfactualRepairRankingGuardrailSuggested ?? null,
      rankingGuardrailKind: counterfactualFields.counterfactualRepairRankingGuardrailKind ?? null,
    });
  }
  ...
  private emitH3Evidence(
    ...
    const dynamicPrecisionFields = this.getDynamicPrecisionRegimeEvidenceFields(chunkId, counterfactualRepairFields, {
      commandClass: overrides.commandClass ?? latest?.commandClass ?? undefined,
      parameterType: overrides.parameterType ?? latest?.parameterType ?? undefined,
    });
    emitH3RuntimeEvidence({
      ...
      dynamicPrecisionRegimeSchemaVersion: overrides.dynamicPrecisionRegimeSchemaVersion ?? dynamicPrecisionFields.dynamicPrecisionRegimeSchemaVersion,
      dynamicPrecisionRegimePolicyVersion: overrides.dynamicPrecisionRegimePolicyVersion ?? dynamicPrecisionFields.dynamicPrecisionRegimePolicyVersion,
      dynamicPrecisionCurrentRegimeId: overrides.dynamicPrecisionCurrentRegimeId ?? dynamicPrecisionFields.dynamicPrecisionCurrentRegimeId,
      dynamicPrecisionCurrentRegimeSource: overrides.dynamicPrecisionCurrentRegimeSource ?? dynamicPrecisionFields.dynamicPrecisionCurrentRegimeSource,
      dynamicPrecisionCurrentRegimeReasonCodes: overrides.dynamicPrecisionCurrentRegimeReasonCodes ?? dynamicPrecisionFields.dynamicPrecisionCurrentRegimeReasonCodes,
      dynamicPrecisionEscalationPilotVersion: overrides.dynamicPrecisionEscalationPilotVersion ?? dynamicPrecisionFields.dynamicPrecisionEscalationPilotVersion,
      dynamicPrecisionEscalationPilotApplied: overrides.dynamicPrecisionEscalationPilotApplied ?? dynamicPrecisionFields.dynamicPrecisionEscalationPilotApplied,
      dynamicPrecisionEscalationSuggested: overrides.dynamicPrecisionEscalationSuggested ?? dynamicPrecisionFields.dynamicPrecisionEscalationSuggested,
      dynamicPrecisionProposedRegimeId: overrides.dynamicPrecisionProposedRegimeId ?? dynamicPrecisionFields.dynamicPrecisionProposedRegimeId,
      dynamicPrecisionEscalationSource: overrides.dynamicPrecisionEscalationSource ?? dynamicPrecisionFields.dynamicPrecisionEscalationSource,
      dynamicPrecisionEscalationReasonCodes: overrides.dynamicPrecisionEscalationReasonCodes ?? dynamicPrecisionFields.dynamicPrecisionEscalationReasonCodes,
      dynamicPrecisionStressBand: overrides.dynamicPrecisionStressBand ?? dynamicPrecisionFields.dynamicPrecisionStressBand,
      dynamicPrecisionFamilyPolicyId: overrides.dynamicPrecisionFamilyPolicyId ?? dynamicPrecisionFields.dynamicPrecisionFamilyPolicyId,
      dynamicPrecisionHysteresisState: overrides.dynamicPrecisionHysteresisState ?? dynamicPrecisionFields.dynamicPrecisionHysteresisState,
      dynamicPrecisionTransitionAllowed: overrides.dynamicPrecisionTransitionAllowed ?? dynamicPrecisionFields.dynamicPrecisionTransitionAllowed,
      multiResolutionAtlasTailStrategyRoutingCandidateTailStrategyId:
